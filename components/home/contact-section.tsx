          ...
          <div className="space-y-12">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-red-600 font-black uppercase tracking-[0.3em] text-[10px]">Contact Bureau</span>
              </div>
              ...
              <p className="text-lg text-slate-500 leading-relaxed max-w-md font-medium">
                Our team in Berlin and abroad is ready to engineer your transition. Reach out for Ausbildung, Dossier, or Language inquiries.
              </p>
            </motion.div>
...
<div className="grid sm:grid-cols-2 gap-4">
  ...
  <div className="p-6 rounded-[2rem] bg-slate-50 border border-slate-100 group hover:border-red-600/20 transition-all duration-300">
    ...
    <h3 className="font-black text-slate-900 uppercase tracking-widest text-xs mb-1">Direct Email</h3>
    <a href="mailto:hello@deutschprepa.de" className="text-sm text-slate-500 font-bold hover:text-red-600 transition-colors">
  ...
  <div className="p-6 rounded-[2rem] bg-slate-50 border border-slate-100 group hover:border-[#25D366]/20 transition-all duration-300">
    ...
    <h3 className="font-black text-slate-900 uppercase tracking-widest text-xs mb-1 text-[#25D366]">WhatsApp Live</h3>
    <a 
      ...
      +49 30 1234567
            ...
            <div className="space-y-6 border-t border-slate-100 pt-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-black text-slate-900 uppercase tracking-widest text-xs">Berlin Headquarters</h4>
                  <p className="text-slate-500 text-sm font-medium">Friedrichstraße 123, 10117 Berlin, Germany</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-200 p-8 md:p-12 shadow-2xl shadow-slate-200/50">
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Service Selection</label>
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Message Context</label>
                  <textarea 
                    rows={4} 
