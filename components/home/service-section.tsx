...
const services: ServiceItem[] = [
  {
    ...
    description: "Your journey starts with communication. Reach C1 level with native instructors designed for professionals.",
  ...
  },
  {
    ...
    description: "We build DIN 5008 compliant professional German applications (Lebenslauf & Motivation Letter).",
    image: "https://images.unsplash.com/photo-1454496406107-dc34337da8d6?q=80&w=1300&auto=format&fit=crop",
    icon: FileText,
  ...
  },
  {
    ...
    description: "We connect you with top companies across Germany for vocational training and visa finalization.",
    image: "https://images.unsplash.com/photo-1618259278412-2819cbdea4dc?q=80&w=1121&auto=format&fit=crop",
    icon: Briefcase,
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mb-32 overflow-hidden">
          ...
          >
            ...
            <span className="text-amber-500 font-black uppercase tracking-[0.4em] text-[10px]">The Bureau Process</span>
          </motion.div>
        ...
        >
          {services.map((service) => (
            <div key={service.id} className="group relative">
              ...
              <div className={`relative z-10 flex flex-col h-full bg-white/[0.02] border border-white/10 rounded-[2.5rem] overflow-hidden transition-all duration-700 ${service.glowColor} hover:bg-white/[0.05] backdrop-blur-md`}>
                ...
                <div className="h-60 w-full overflow-hidden relative">
                  ...
                  />
                  {/* ICON BADGE */}
                  <div className={`absolute bottom-5 left-8 z-20 w-16 h-16 rounded-2xl bg-black border border-white/10 flex items-center justify-center shadow-2xl transition-transform duration-500 group-hover:-translate-y-2 ${service.accentColor}`}>
                ...
                <div className="p-10 pt-10 flex flex-col flex-grow">
                  ...
                  <ul className="space-y-4 mb-12 flex-grow">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center gap-4">
                        <CheckCircle2 className={`w-4 h-4 ${service.accentColor} opacity-20 group-hover:opacity-100 transition-opacity duration-500`} />
                  ...
                  <Link href={`/services/${service.route}`}>
                    <Button 
                      className="w-full h-16 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] transition-all duration-500 group/btn bg-white/5 border border-white/10 text-white hover:bg-red-600 hover:border-red-600 hover:shadow-[0_0_30px_rgba(220,38,38,0.2)]"
                    >
                      {service.cta}
