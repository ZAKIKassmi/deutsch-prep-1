...
const steps = [
  {
    ...
    description: "Our experts analyze your current papers to meet German 'Anerkennung' standards.",
    image: "https://images.unsplash.com/photo-1554774853-aae0a22c8aa4?q=80&w=1470&auto=format&fit=crop",
    features: ["Verification of Degrees", "Transcript Analysis", "Equivalency Check"],
    color: "from-rose-500 to-pink-600"
  },
  {
    id: "02",
    title: "The Lebenslauf Factory",
    description: "We craft a high-impact, DIN 5008 compliant resume and tailored Motivation Letter.",
  ...
  },
  {
    ...
    description: "We organize your telc/Goethe certs and internship proofs into a clean digital dossier.",
    image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=1470&auto=format&fit=crop",
    features: ["telc/Goethe Validation", "Internship Proofs", "Translation Support"],
    color: "from-violet-600 to-purple-600"
  },
  {
    id: "04",
    title: "Final Placement",
    description: "Your dossier is ready. We connect you with top German companies for your Ausbildung.",
    image: "https://images.unsplash.com/photo-1521791136064-7986c2923216?q=80&w=1469&auto=format&fit=crop",
    ...
    <section ref={targetRef} className="relative h-[300vh] bg-[#0a0a0a]">
      ...
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <div className="absolute top-10 left-10 opacity-[0.03] select-none pointer-events-none">
          <h2 className="text-[20vw] font-black text-white leading-none uppercase">Workflow</h2>
        </div>
        ...
        <motion.div style={{ x }} className="flex gap-12 px-12 md:px-24">
          ...
          <div className="flex h-[70vh] w-[300px] md:w-[500px] flex-col justify-center shrink-0">
             <span className="text-rose-500 font-black tracking-[0.3em] uppercase text-xs mb-4">Inside the factory</span>
             <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-none mb-8">
               Building <br/> Your <span className="text-rose-600 italic font-serif">Future.</span>
             </h2>
            ...
            >
              ...
              <div className="absolute inset-0 p-8 md:p-12 flex flex-col">
                <div className="flex justify-between items-start mb-auto">
                  <div className={`text-4xl font-black text-white opacity-20`}>{step.id}</div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-3 pt-4 border-t border-white/10">
                    {step.features.map((feat) => (
                      <div key={feat} className="flex items-center gap-2 text-xs font-bold text-white/80 uppercase tracking-wide">
          ...
          <div className="flex h-[70vh] w-[350px] md:w-[500px] shrink-0 flex-col items-center justify-center text-center p-12 rounded-[2.5rem] bg-rose-600">
             ...
             <h3 className="text-4xl font-black text-white uppercase mb-4 leading-none">Your Dossier is Ready.</h3>
             <p className="text-white/80 mb-8">Stop worrying about paperwork. Start packing your bags for Germany.</p>
