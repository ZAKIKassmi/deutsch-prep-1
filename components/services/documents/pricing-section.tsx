...
const tiers = [
  {
    ...
    price: "99",
    description:
      "The essential German first impression. Perfect if you already have your other papers ready.",
    icon: FileText,
    features: [
  ...
  },
  {
    ...
    price: "249",
    description:
      "The Total Factory Solution. We handle every single document needed for your German journey.",
    icon: FolderPlus,
    features: [
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-white/50 text-lg max-w-xl mx-auto">
            From a professional CV to a complete ready-to-move folder, we
            engineer your success in Germany.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {tiers.map((tier, idx) => (
            ...
            >
              ...
              <div className="mb-8">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${tier.highlight ? "bg-rose-500 text-white" : "bg-white/10 text-white/40"}`}
                >
              ...
              <div className="space-y-4 mb-12 flex-grow">
                ...
                {tier.features.map((feature) => (
                  <div key={feature} className="flex items-start gap-3 group">
                    <div
                      className={`mt-1 transition-colors ${tier.highlight ? "text-rose-500" : "text-white/20"}`}
                    >
